 ...
 * > 22
 */
public class TemperatureReduceDemo {
    ...
    public static void main(final String[] args) {
        ...
        final KStream<String, String> source = builder.stream("iot-temperature1");
        ...
        final KStream<Windowed<String>, String> max = source
            ...
            .reduce((value1, value2) -> {
                ...
                try {
                    Integer a = Integer.parseInt(value1);
                    Integer b = Integer.parseInt(value2);

 ...
 */
package com.ss.kafka.streams.demo;
 ...
 * > 22
 */
public class TemperatureJsonDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "streams-temperature2");
        props.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "hadoop001:9092");
        ...
        KStream<String, String> source = builder.stream("iot-temperature2");
        ...
        max.to("iot-temperature-max2", Produced.with(windowedSerde, Serdes.String()));
